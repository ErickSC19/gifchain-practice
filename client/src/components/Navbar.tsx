  ...
  return (
    <nav className="w-full flex md:justify-center justify-between items-center p-4">
      ...
      <div className="flex relative">
        ...
        {toggleMenu && (
          <ul
          className='z-10 fixed top-0 -right-2 p-3 w-[70vw] h-screen shadow-2xl md:hidden list-none flex flex-col justify-center items-end rounded-md blue-glassmorphism text-white animate-slide-in'>
